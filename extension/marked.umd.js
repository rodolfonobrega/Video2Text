...
(function (g, f) {
  ...
  var Te = (l, e) => {
      for (var t in e) Z(l, t, { get: e[t], enumerable: !0 });
    },
    Oe = (l, e, t, n) => {
      if ((e && typeof e == 'object') || typeof e == 'function')
        for (let r of be(e))
          !Re.call(l, r) &&
            r !== t &&
            Z(l, r, { get: () => e[r], enumerable: !(n = xe(e, r)) || n.enumerable });
      return l;
    };
  var we = (l) => Oe(Z({}, '__esModule', { value: !0 }), l);
  var kt = {};
  Te(kt, {
    Hooks: () => S,
    Lexer: () => x,
  ...
  var ye = (() => {
    ...
    B = { normal: K, gfm: Ee, pedantic: Be },
    M = { normal: X, gfm: N, breaks: nt, pedantic: tt };
  var rt = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' },
    de = (l) => rt[l];
  function w(l, e) {
    if (e) {
    ...
    heading(e) {
      ...
      if (t) {
        ...
        if (this.rules.other.endingHash.test(n)) {
          let r = z(n, '#');
          (this.options.pedantic || !r || this.rules.other.endingSpaceChar.test(r)) &&
            (n = r.trim());
        }
        return {
          type: 'heading',
...
`),
        ...
        for (; n.length > 0; ) {
          ...
          for (u = 0; u < n.length; u++)
            if (this.rules.other.blockquoteStart.test(n[u])) (o.push(n[u]), (a = !0));
...
`),
              O = this.blockquote(f);
            ((s[s.length - 1] = O),
              (r = r.substring(0, r.length - R.raw.length) + O.raw),
...
`,
              ...
              .replace(this.rules.other.listReplaceTabs, (O) => ' '.repeat(3 * O.length)),
            h = e.split(
              `
`,
              1
...
`,
              ...
              if (
                ...
                ee.test(h) || te.test(h) || me.test(h) || O.test(h) || Y.test(h))
              )
                break;
              ...
              ((u.checked = c.checked),
                i.loose
                  ? u.tokens[0] &&
                    ...
                    u.tokens[0].tokens
                    ? ((u.tokens[0].raw = c.raw + u.tokens[0].raw),
                      (u.tokens[0].text = c.raw + u.tokens[0].text),
                      u.tokens[0].tokens.unshift(c))
                    : u.tokens.unshift({ type: 'paragraph', raw: c.raw, text: c.raw, tokens: [c] })
                  : u.tokens.unshift(c));
            }
          }
          if (!i.loose) {
            let p = u.tokens.filter((g) => g.type === 'space'),
  ...
  var x = class l {
    ...
    constructor(e) {
      ...
      (this.options.pedantic
        ...
        : this.options.gfm &&
          ((t.block = B.gfm), this.options.breaks ? (t.inline = M.breaks) : (t.inline = M.gfm)),
    ...
    parse(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        if (this.options.extensions?.renderers?.[r.type]) {
          let s = r,
            a = this.options.extensions.renderers[s.type].call({ parser: this }, s);
          if (
            a !== !1 ||
            ![
              'space',
                ...
                : (i[a] = (...p) => {
                    if (this.defaults.async)
                      return (async () => {
                        ...
                        return (g === !1 && (g = await u.apply(i, p)), g);
                      })();
                    let c = o.apply(i, p);
                    return (c === !1 && (c = u.apply(i, p)), c);
                  });
      ...
      return (n, r) => {
        ...
        if ((s.hooks && ((s.hooks.options = s), (s.hooks.block = e)), s.async))
          return (async () => {
            ...
            let h = await (s.hooks ? await s.hooks.provideParser() : e ? b.parse : b.parseInline)(
              c,
              s
            );
